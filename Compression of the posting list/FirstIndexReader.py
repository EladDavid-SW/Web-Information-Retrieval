...
class FirstIndexReader:
    ...
    def __init__(self, dir):
        ...
        with open(full_path, "rb") as file:
            ...
            self.num_of_blocks = (self.file_len - self.dic_len - 4) // 102
            ...
            for block in range(self.num_of_blocks):
                ...
                self.blocks[block][0]["ptr_pl"] = unpack('l', file.read(4))[0]
                ...
                for inner_block in range(1, 9):
                    ...
                    self.blocks[block][inner_block]["ptr_pl"] = unpack('l', file.read(4))[0]
                ...
                self.blocks[block][9]["ptr_pl"] = unpack('l', file.read(4))[0]
    ...
    def getNextToken(self, token):
        ...
        if word == token:
            if next_block_ptr == self.dic_len:
                return -2
            else:
                return self.blocks[index_block + 1][0]
